      ...
      <KeyboardAvoidingView
        ...
        <ScrollView style={styles.contentBody}>
          ...
          <View style={styles.itemContainer}>
            ...
            <View style={[styles.inputContainer, isFieldValid('membershipNumber') && styles.validInput, errList.membershipNumber&&styles.ivalidInput]}>
              ...
              <TextInput
                ...
                style={styles.inputFiled} placeholder='54321' />
            </View>
          </View>
          ...
          <View style={styles.itemContainer}>
            ...
            <View style={[styles.inputContainer, isFieldValid('fullName') && styles.validInput,errList.fullName&&styles.ivalidInput]}>
              <AntDesign name="user" size={24} color="white" />
              <TextInput
                value={userInfo.fullName}
                onChangeText={(value) => handleValues('fullName', value)}
                style={styles.inputFiled} placeholder='Albert Einstine' />
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={[styles.itemContainer, { flex: 1 }]}>
              ...
              <View style={[styles.inputContainer, isFieldValid('age') && styles.validInput,errList.age&&styles.ivalidInput]}>
                <Ionicons name="calendar-number" size={24} color={textPimary} />
                <TextInput
                  keyboardType='numeric'
                  value={userInfo.age?.toString()}
                  onChangeText={(value) => handleValues('age', value)}
                  style={styles.inputFiled} placeholder='21' />
              </View>
            </View>
            <View style={[styles.itemContainer, { flex: 3 }]}>
              <Text style={styles.inputTextHeading}>Contact Number</Text>
              <View style={[styles.inputContainer, isFieldValid('contactNumber') && styles.validInput,errList.contactNumber&&styles.ivalidInput]}>
                <Feather name="smartphone" size={24} color={textPimary} />
                <TextInput
                  value={userInfo.contactNumber}
                  keyboardType='numeric'
                  onChangeText={(value) => handleValues('contactNumber', value)}
                  style={styles.inputFiled} placeholder='0771234567' />
              </View>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={[styles.itemContainer, { flex: 1 }]}>
              ...
              <View style={[styles.inputContainer, isFieldValid('height') && styles.validInput,errList.height&&styles.ivalidInput]}>
                ...
                <TextInput
                  ...
                  style={styles.inputFiled} placeholder='160' />
              </View>
            </View>
            <View style={[styles.itemContainer, { flex: 1 }]}>
              <Text style={styles.inputTextHeading}>Weight (KG)</Text>
              <View style={[styles.inputContainer, isFieldValid('weight') && styles.validInput,errList.weight&&styles.ivalidInput]}>
                ...
                <TextInput
                  ...
                  style={styles.inputFiled} placeholder='75' />
              </View>
            </View>
          </View>
          ...
          <View style={[styles.itemContainer]}>
            ...
            <View style={{ flexDirection: 'row', padding: 10, gap: 10 }}>
              <Pressable
                ...
                style={({ pressed }) => [pressed && { opacity: 0.5 }, styles.genderBtn, userInfo.gender === 'male' && { backgroundColor: 'rgb(32, 74, 130)' }]}>
              ...
              <Pressable
                ...
                style={({ pressed }) => [pressed && { opacity: 0.5 }, styles.genderBtn, userInfo.gender === 'female' && { backgroundColor: 'rgb(111, 58, 155)' }]}>
          ...
          <View style={styles.itemContainer}>
            ...
            <View style={[styles.inputContainer, isFieldValid('email') && styles.validInput,errList.email&&styles.ivalidInput]}>
              <MaterialCommunityIcons name="email-variant" size={24} color={textPimary} />
              <TextInput
                value={userInfo.email}
                onChangeText={(value) => handleValues('email', value)}
                style={styles.inputFiled} placeholder='someone@somewhere.com' />
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={[styles.itemContainer, { flex: 1 }]}>
              ...
              <View style={[styles.inputContainer, isFieldValid('password') && styles.validInput,errList.password&&styles.ivalidInput]}>
                <FontAwesome5 name="lock" size={24} color={textPimary} />
                <TextInput
                  secureTextEntry
                  value={userInfo.password}
                  onChangeText={(value) => handleValues('password', value)}
                  style={styles.inputFiled} placeholder='*********' />
              </View>
            </View>

            <View style={[styles.itemContainer, { flex: 1 }]}>
              <Text style={styles.inputTextHeading}>Confirm Password</Text>
              <View style={[styles.inputContainer, isFieldValid('confirmedPwd') && styles.validInput,errList.confirmedPwd&&styles.ivalidInput]}>
                <FontAwesome5 name="lock" size={24} color={textPimary} />
                <TextInput
                  secureTextEntry
...
const styles = StyleSheet.create({
  ...
  validInput: { backgroundColor: 'rgba(115, 240, 184, 0.46)' },
   ivalidInput: { backgroundColor: 'rgba(104, 98, 57, 0.93)' },
  genderBtn: {
