 ...
 export const packages: Package[] = [
    {
      id: 'workout_only',
      name: 'Workout Only',
      description: 'Structured routines to build strength, endurance, and flexibility — no extra equipment needed',
      includes: [
        'All strength training equipment',
        'Free weights area',
        'Functional training zone',
        'Locker access'
      ],
      price: 3000,
      icons:[packageIcons.workouts]
    
    },
    {
      id: 'workout_treadmill',
      name: 'Workout + Treadmill',
      description: 'Balanced training with workouts plus treadmill cardio for stamina and calorie burn',
      includes: [
      ...
      price: 3500, 
      icons:[packageIcons.workouts,packageIcons.treadmill]
    },
    {
      id: 'zumba_only',
      name: 'Zumba Only',
      description: 'Fun, high-energy dance workouts that burn calories and boost coordination.',
      includes: [
        'Daily Zumba classes',
        'Professional instructors',
        'Group workout environment',
        'Locker access'
      ],
      price: 2500,
      icons:[packageIcons.zumba]
    },
    {
      id: 'workout_zumba',
      name: 'Zumba + Workouts',
      description: 'Dance-powered cardio combined with strength-focused workouts for a complete fitness mix',
      includes: [
        'All gym equipment',
      ...
      price: 5500,
      icons:[packageIcons.zumba,packageIcons.workouts]
     
    },
     {
      id: 'workout_zumba_treadmill',
      name: 'Zumba + Workouts + Treadmill',
      description: 'Dance-powered cardio combined with strength-focused workouts for a complete fitness mix',
      includes: [
        'All gym equipment',
        'Unlimited Zumba classes',
      ...
      price: 5500,
      icons:[packageIcons.zumba,packageIcons.workouts,packageIcons.treadmill]
